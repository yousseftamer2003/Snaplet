...
/// Attributes used by [BackgroundExposureLayer]
class BackgroundExposureLayerData extends Layer {
  double exposure;

  BackgroundExposureLayerData({
  ...
  static BackgroundExposureLayerData fromJson(Map json) {
    var layer = BackgroundExposureLayerData(
